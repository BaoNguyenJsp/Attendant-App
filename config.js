...
const cfg = {
  ...
  appsScriptUrl: process.env.APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbwNBb08pQABeTHS7qBVaAqAonMJfZ42tA8P1gUpQKfcQL3KmuyhkBuGSr7V_zRusd-M/exec',
