...
const cfg = {
  ...
  appsScriptUrl: process.env.APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbz1rvAEEHOLNBQblxJHxC5XUlD7eq6Er3z_oOjQGOpi1GYxxC9Y6Y_rAqRPspGBFwOt/exec',
