...
const cfg = {
  ...
  appsScriptUrl: process.env.APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbzaXqeZdhNpW3_8P7kggXYvm3zNdI1C8plsWrdRKD5FX6Agjskpw3wt3jVVX3ObYokY/exec',
