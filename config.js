...
const cfg = {
  ...
  appsScriptUrl: process.env.APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbyJsu37JuKzjKVOf8di9rcXAKSZFWALkpaSTbzdnLT-mzqbfzKmxvKz7xhflWBmxniK/exec',
