...
const cfg = {
  ...
  appsScriptUrl: process.env.APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbw4dX9V9KjiDXkenQEGURNV6lkGlsqshVa4siBHdHAItmuSplFtTossBuD42TVvK9xU/exec',
